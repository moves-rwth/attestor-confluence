...
In this case both abstractions can be applied one after another and still lead to the same hypergraph regardless of the order in which the abstractions are applied. \todo{Note that all our rules are injective.}
\end{definition}
...
\todo{Not sure if this is really what this theorem is about}
