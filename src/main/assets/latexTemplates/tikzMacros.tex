...
\newcommand{\AttestorCriticalPairReport}{
    ...
    \begin{tikzpicture}
        \matrix[ampersand replacement=\&, anchor=south west, column sep=1cm, row sep=1.5cm] (matrix) {
        ...
        \node[anchor=south] (jointGraph) at ($ (appliedR1.north)!.5!(appliedR2.north) + (0,1.5)$) {\tikz{\AttestorDrawHeapConfiguration{/joint graph}}};
