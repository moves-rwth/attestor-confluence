...
\newcommand{\AttestorCriticalPairReport}{
    ...
    \begin{tabular}{cc}
        \multicolumn{2}{c}{\AttestorDrawHeapConfiguration{/joint graph}}\\
        \AttestorDrawHeapConfiguration{/applied rule 1} & \AttestorDrawHeapConfiguration{/applied rule 2}\\
        \AttestorDrawHeapConfiguration{/canonical 1} & \AttestorDrawHeapConfiguration{/canonical 2}\\
    \end{tabular}
...
\newcommand{\AttestorGrammarReport}{
    ...
    \begin{tikzpicture}
        \begin{scope}[local bounding box=scope1]
            \AttestorDrawHeapConfiguration{/left hand side}
        \end{scope}
        \node
