...
\newcommand{\AttestorCriticalPairReport}{
    ...
    \begin{tabular}{cc}
        ...
        \tikz{\AttestorDrawHeapConfiguration{/applied rule 1}} & \tikz{\AttestorDrawHeapConfiguration{/applied rule 2}}\\
        \tikz{\AttestorDrawHeapConfiguration{/canonical 1}} & \tikz{\AttestorDrawHeapConfiguration{/canonical 2}}\\
    \end{tabular}
